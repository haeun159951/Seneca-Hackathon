...
!(function(e, t) {
  ...
  var c = function(t, r) {
    ...
    for (
      var a = h.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, d = 0;
      d < 2;
      d++
    ) {
  ...
  (c.DEFAULTS = {
    ...
    (c.prototype = {
      ...
      loadImage: function() {
        ...
        s = this.context;
        var t =
          this.imageUrl || n(this.originalCssBackgroundImage) || n(this.$el.css('backgroundImage'));
      ...
      step: function() {
        (s = this.context),
          this.visible &&
            (this.computeTextureBoundaries(), this.running && this.update(), this.render());
      },
      drawQuad: function() {
        s.bindBuffer(s.ARRAY_BUFFER, this.quad),
      ...
      computeTextureBoundaries: function() {
        ...
        if (
          ('fixed' == o
            ? (((e = { left: window.pageXOffset, top: window.pageYOffset }).width = u.width()),
              (e.height = u.height()))
